            ...
            <div class="container" v-if="!loadingContents && contents[0]">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-md-push-7">
                        <div class="appointment-form clearfix">
                            <form @submit.prevent="submit()" class="row cols_10">
                                <div class="col-xs-12">
                                    <input type="text" v-model="record.name" placeholder="Company">
                                ...
                                <div class="col-xs-12">
                                    <label class="pretty-check noselect f_size_14" for="accepted_terms">
                                        ...
                                        I did read and accept <nuxt-link :to="{ name: 'terms-and-conditions-partner' }">Terms and Conditions</nuxt-link>
                                    </label>
                    ...
                    <div class="col-sm-12 col-md-6 col-md-pull-3">
                        <figure>
                            <img src="/images/theme/partner.jpg" alt="image" title="Partner register" class="img-responsive m_0_auto">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            submit () {
                ...
                createPartner(this.$axios, payload)
                    .then(() => {
                        this.errors = {}
                        this.clear()
