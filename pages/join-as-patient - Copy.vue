            ...
            <div class="container" v-if="!loadingContents && contents[0]">
                ...
                <div class="row">
                        ...
                        <div class="appointment-form clearfix">
                            <form @submit.prevent="submit()" class="row">
                                ...
                                <div class="col-xs-12 d_flex">
                                    ...
                                    <div style="width: 100%">
                                        <input type="number" v-model="record.phone" placeholder="Phone">
                                ...
                                <div class="col-xs-12">
                                    <label class="pretty-check noselect f_size_14" for="accepted_terms">
                                        ...
                                        I did read and accept <nuxt-link :to="{ name: 'terms-and-conditions-patient' }">Terms and Conditions</nuxt-link>
                                    </label>
                    ...
                    <div class="col-sm-12 col-md-6 col-md-pull-3">
                        <figure>
                            <img src="/images/theme/patient.jpg" alt="image" title="Patient register" class="img-responsive m_0_auto">
                        </figure>
                    </div>
                </div>
            </div>
    ...
    export default {
        ...
        methods: {
            submit () {
                ...
                createPatient(this.$axios, payload)
                    .then(() => {
                        this.errors = {}
                        this.clear()
